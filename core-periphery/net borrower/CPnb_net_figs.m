...
if liqinj == 0
    load('IRF_CPnb_noLI.mat');
    load('varsCPnb_noLI.mat');
    LI = 'noliqinj';
elseif liqinj == 1
    load('IRF_CPnb_LI.mat');
    load('varsCPnb_LI.mat');
    LI = 'liqinj';
end
...
%% Interest rates
 ...
 %set(groot,'DefaultAxesColorOrder', [hex2rgb('e41a1c'); hex2rgb('ff7f00'); hex2rgb('4daf4a'); hex2rgb('984ea3')] )
...
subplot(1,2,1);
        ...
        set(h,'linewidth',1.5);
        title({'$r^{b,AB}-r^{b,CA}$'},'FontSize',8,'interpreter','latex');
...
%             'southoutside','interpreter','latex','Orientation','horizontal','box','off');
%         set(l,'units','pixels');
%         set(l,'position',[5 5 500 15])
        xlim([0,truncsim]);
subplot(1,2,2);
        ...
        set(gca,'FontSize',6,'box','off');
        set(h,'linewidth',1.5);
        title({'$r^{b,AB}-r^{b,DA}$'},'FontSize',8,'interpreter','latex');
        %xlabel('quarters after shock')
        xlim([0,truncsim]);
...
subplot(1,3,2);
        ...
        set(gca,'FontSize',6,'box','off');
        set(h,'linewidth',1.5);
        title({'$L^{b,CA}$'},'FontSize',8,'interpreter', 'latex');
        %xlabel('quarters after shock')
        xlim([0,truncsim]);
subplot(1,3,3);
        ...
        set(gca,'FontSize',6,'box','off');
        set(h,'linewidth',1.5);
        title({'$L^{b,DA}$'},'FontSize',8,'interpreter', 'latex');
        %xlabel('quarters after shock')
        xlim([0,truncsim]);
% subplot(2,3,4);
...
%         set(gca,'FontSize',6,'box','off');
%         set(h,'linewidth',1.5);
%         title({'$B^{b,AC}$'},'FontSize',8,'interpreter', 'latex');
%         xlabel('quarters after shock')
%         xlim([0,truncsim]);
% subplot(2,3,5);
...
%         set(gca,'FontSize',6,'box','off');
%         set(h,'linewidth',1.5);
%         title({'$B^{b,AD}$'},'FontSize',8,'interpreter', 'latex');
%         xlabel('quarters after shock')
%         xlim([0,truncsim]);
% subplot(2,3,6);
...
subplot(1,3,1);
        ...
        set(gca,'FontSize',6,'box','off');
        set(h,'linewidth',1.5);
        title({'$\delta^{b,BA}$'},'FontSize',8,'interpreter', 'latex');
        %legend({'SC_{1}','SC_{2}','SC_{3}','SC_{4}'},'FontSize',6,'Location','best');
        %xlabel('quarters after shock')
        xlim([0,truncsim]);
subplot(1,3,2);
        ...
        set(gca,'FontSize',6,'box','off');
        set(h,'linewidth',1.5);
        title({'$\delta^{b,AC}$'},'FontSize',8,'interpreter', 'latex');
        %xlabel('quarters after shock')
        xlim([0,truncsim]);
subplot(1,3,3);
        ...
        set(gca,'FontSize',6,'box','off');
        set(h,'linewidth',1.5);
        title({'$\delta^{b,AD}$'},'FontSize',8,'interpreter', 'latex');
        %xlabel('quarters after shock');
        xlim([0,truncsim]);
set(gcf, 'PaperUnits', 'centimeters');
set(gcf, 'PaperSize', [15 3]);
...
subplot(1,3,1);
        ...
        set(gca,'FontSize',6,'box','off');
        set(h,'linewidth',1.5);
        title({'$r^{b,AB}$'},'FontSize',8,'interpreter','latex');
...
subplot(1,3,2);
        ...
        set(gca,'FontSize',6,'box','off');
        set(h,'linewidth',1.5);
        title({'$r^{b,CA}$'},'FontSize',8,'interpreter','latex');
        %xlabel('quarters after shock')
        xlim([0,truncsim]);
subplot(1,3,3);
        ...
        set(gca,'FontSize',6,'box','off');
        set(h,'linewidth',1.5);
        title({'$r^{b,DA}$'},'FontSize',8,'interpreter','latex');
        %xlabel('quarters after shock')
        xlim([0,truncsim]);
set(gcf, 'PaperUnits', 'centimeters');
set(gcf, 'PaperSize', [20 3]);
